...
public class BookDoneFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public BookDoneFragment(MainActivity activity) {
    ...
    private void loadDataBook(){
        ...
        LiveData<CommonResponse<List<Book>>> lvData = this.activity.getMainViewModel().bookList(uid, 5);
